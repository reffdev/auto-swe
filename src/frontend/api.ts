...
export function rejectForemanTask(id: string, feedback: string, preserveAssets?: boolean): Promise<ForemanTask> {
  return json(`/api/foreman/tasks/${id}/reject`, { method: "POST", body: JSON.stringify({ feedback, preserveAssets }) });
}
