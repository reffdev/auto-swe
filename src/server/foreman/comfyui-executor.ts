...
export async function executeComfyUITask(
  ...
  try {
    ...
    // Git add and commit — skip for style exploration (outputs go to .swe/ which is gitignored)
    ...
    // Create review gate immediately — don't wait for director scheduler tick
