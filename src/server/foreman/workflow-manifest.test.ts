...
describe("loadWorkflowManifest", () => {
  ...
  it("returns null when no manifest exists", async () => {
    ...
    expect(await loadWorkflowManifest(projectDir)).toBeNull();
  });

  it("returns null when manifest directory exists but no file", async () => {
    projectDir = makeTempProject();
  ...
  it("loads a valid manifest", async () => {
    ...
    const result = await loadWorkflowManifest(projectDir);
...
describe("findWorkflowForAssetType", () => {
  it("finds sprite workflow", async () => {
...
describe("summarizeManifestForPrompt", () => {
  it("includes workflow names and descriptions", async () => {
  ...
  it("includes parameter descriptions", async () => {
    const summary = summarizeManifestForPrompt(sampleManifest);
